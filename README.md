...
However, the posture mode was accurate most of the time across several tests. The system's embouchure analysis was tested alongside a tuner, which was used to verify whether the embouchure feedback was correct.
